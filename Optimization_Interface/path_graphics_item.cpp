...
PathGraphicsItem::PathGraphicsItem(QPointF *point, QVector<QPointF *> *path, QGraphicsItem *parent)
...
{
    QPainterPath path;
    path.addEllipse(QRectF(-PATH_POINT_SIZE / 2, -PATH_POINT_SIZE / 2, PATH_POINT_SIZE, PATH_POINT_SIZE));
    return path;
}
...
QVariant PathGraphicsItem::itemChange(GraphicsItemChange change, const QVariant &value)
{
